import{r as l,o as t,c as p,a as s,b as e,w as o,F as c,d as n,e as i}from"./app.37188918.js";import{_ as r}from"./plugin-vue_export-helper.21dcd24c.js";const d={},u=s("h1",{id:"comments",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#comments","aria-hidden":"true"},"#"),n(" Comments")],-1),m=s("p",null,[n("This section outlines all the builtin comments in the Blizzard Programming Language. Comments are ignored by Blizzard allowing you to write notes for other people about what your code does. Any code that is commented "),s("strong",null,"will not"),n(" be executed.")],-1),h={class:"table-of-contents"},y=n("Inline //"),D=n("Multiline /* */"),A=i(`<h3 id="inline" tabindex="-1"><a class="header-anchor" href="#inline" aria-hidden="true">#</a> Inline <code>//</code></h3><p>Inline comments are preceded by 2 forward slashes <code>//</code> and continue until the end of the line.</p><div class="language-bzz ext-bzz"><pre class="shiki" style="background-color:#1E1E1E;"><code><span class="line"><span style="color:#569CD6;">str</span><span style="color:#D4D4D4;"> name = </span><span style="color:#CE9178;">&quot;John Smith&quot;</span><span style="color:#D4D4D4;">; </span><span style="color:#6A9955;">// Keep track of the person&#39;s name</span></span>
...
<span class="line"><span style="color:#6A9955;">*/</span></span>
<span class="line"></span></code></pre></div>`,6);function f(_,b){const a=l("RouterLink");return t(),p(c,null,[u,m,s("nav",h,[s("ul",null,[s("li",null,[e(a,{to:"#inline"},{default:o(()=>[y]),_:1})]),s("li",null,[e(a,{to:"#multiline"},{default:o(()=>[D]),_:1})])])]),A],64)}var g=r(d,[["render",f]]);export{g as default};
